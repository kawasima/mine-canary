(ns mine-canary.example.log-collector.core
...
(defagent :a1
  (flume/source :r1
          :type "mine-canary.example.log-collector.core/oracle-insert-source"
          :channels :c1)
  (flume/sink :k1
        :type "mine-canary.example.log-collector.core/ulon-colon-sink"
        :channel :c1)
  (flume/channel :c1
           :type "memory"
           :capacity 1000
